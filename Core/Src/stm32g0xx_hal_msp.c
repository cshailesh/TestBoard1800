...
void HAL_SPI_MspInit(SPI_HandleTypeDef* hspi)
{
  ...
  /* USER CODE END SPI1_MspInit 0 */
    ...
    PA7     ------> SPI1_MOSI
    */
    GPIO_InitStruct.Pin = FRAM_CLK_Pin|FRAM_SO_Pin|FRAM_SI_Pin;
...
void HAL_SPI_MspDeInit(SPI_HandleTypeDef* hspi)
{
  ...
  /* USER CODE END SPI1_MspDeInit 0 */
    ...
    PA7     ------> SPI1_MOSI
    */
    HAL_GPIO_DeInit(GPIOA, FRAM_CLK_Pin|FRAM_SO_Pin|FRAM_SI_Pin);
...
void HAL_UART_MspDeInit(UART_HandleTypeDef* huart)
{
  ...
  /* USER CODE END USART1_MspDeInit 0 */
    ...
    PB7     ------> USART1_RX
    */
    HAL_GPIO_DeInit(GPIOB, RS485_1_DE_Pin|RS485_1_TX_Pin|RS485_1_RX_Pin);
  ...
  /* USER CODE END USART3_MspDeInit 0 */
    ...
    PC10     ------> USART3_TX
    */
    HAL_GPIO_DeInit(RS485_2_DE_GPIO_Port, RS485_2_DE_Pin);
